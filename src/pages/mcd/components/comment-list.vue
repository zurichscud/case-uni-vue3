  ...
  <view>
    <view class="list_block m-30">
      <view class="img_block">
        <image class="userImg" :src="appConfig.defaultAvatar"></image>
      </view>
          ...
          <view class="flex_between">
            ...
            <view class="flex_between">
              <image
                class="like_img"
                :src="
                  refDataObj.active ? '../../../static/like_active.png' : '../../../static/like.png'
                "
                mode=""
              ></image>
              <view
                class="like_color fz_28"
                :class="refDataObj.active ? 'active_style' : ''"
                @click="like"
              >
